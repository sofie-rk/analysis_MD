...
color_salt_conc = colors_Dark2#colors_seq_blue
color_salt_conc2 = colors_Dark2#colors_seq_pink
...
martini_0point6 = ProteinAnalysisTrajectory('/salt_concentration/MARTINI_sc3_v2.gro', '/salt_concentration/MARTINI_sc3_v2.xtc', color=next(color_salt_conc), label='MARTINI 0.6 mol/L')
...
opls_0point6 = ProteinAnalysisTrajectory('/salt_concentration/OPLS_sc3_v2.gro', '/salt_concentration/OPLS_sc3_v2.xtc', color=next(color_salt_conc2), label='OPLS 0.6 mol/L')
...
proteins_martini = [martini_neutral, martini_0point3, martini_0point6, martini_0point9]
...
rgyr_plot(proteins_martini)
rgyr_plot(proteins_opls)
